"""
Entidad de dominio para Lavadores (Washers).

Los Washers son trabajadores que realizan servicios de lavado de vehículos
y reciben bonos basados en su porcentaje de comisión.
"""
